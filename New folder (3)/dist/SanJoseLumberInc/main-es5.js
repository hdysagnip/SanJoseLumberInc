(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageProductComponent = /** @class */ (function () {
                ...
                ManageProductComponent.prototype.getProducts = function () {
                    var _this = this;
                    this.productService.getProducts().subscribe(function (data) {
                        _this.products = data;
                    });
                };
                ManageProductComponent.prototype.addProduct = function () {
                    var _this = this;
                    var product = new _product__WEBPACK_IMPORTED_MODULE_3__["Product"]();
                ...
                ManageProductComponent.prototype.updateProduct = function (id) {
                    var _this = this;
                    if (confirm("Update product info?")) {
                        ...
                        product.quantity = this.productQty;
                        product.price = this.productPrice;
                        this.productService.updateProduct(product, id).subscribe(function (data) {
                            console.log(data);
                            _this.getProducts();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ManageTransactionComponent = /** @class */ (function () {
                function ManageTransactionComponent() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductService = /** @class */ (function () {
                ...
                ProductService.prototype.updateProduct = function (product, id) {
